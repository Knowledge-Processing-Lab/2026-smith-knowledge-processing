...
# R Script
## Purpose: Create accuracy tables (Supplementary Table 1-4).
# N.B. Tables are exported as .docx and require MS Word (or equivalent) to open.
## Inputs: data/processed/clean_data.rds
## Outputs:
# outputs/tables/E1_accuracy.docx
# outputs/tables/E2_accuracy.docx
# outputs/tables/E3_accuracy_negated.docx
# outputs/tables/E3_accuracy_affirmed.docx
## Authors: Peney, T.
